...
class group_override_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_group_override_created', 'mod_redaction');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created a group override with id '$this->objectid' " .
