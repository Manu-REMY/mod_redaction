 ...
 *
 * This event is fired when a student submits their work
 * (changing status from draft to submitted) in a redaction activity.
 *
...
/**
 * Submission submitted event class.
 *
 * @package    mod_redaction
 * @copyright  2026 Emmanuel REMY
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class submission_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_submission_submitted', 'redaction');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' submitted their work with submission id '$this->objectid' " .
