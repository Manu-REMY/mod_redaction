...
class user_override_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_user_override_updated', 'mod_redaction');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated user override with id '$this->objectid' " .
