...
class user_override_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_user_override_deleted', 'mod_redaction');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted user override with id '$this->objectid' " .
